        ...
        <div class="row">
                ...
                <div class="navbar-expand-lg navbar-vertical mb-3 mb-lg-5">
                    ...
                    <div id="navbarVerticalNavMenu" class="collapse navbar-collapse">
                        <ul id="navbarSettings"
                            ...
                            @if($user->role == 1)
                                <li class="nav-item">
                                    <a class="nav-link active" href="#ai-feature">
                                        <i class="bi-cash nav-icon"></i> @lang('Ai Feature')
                                    </a>
                                </li>
                            @endif
                            <li class="nav-item">
                                <a class="nav-link active" href="#affiliate_able">
                                    <i class="bi-cash nav-icon"></i> @lang('Affiliateable')
                                </a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="col-lg-9">
                <div class="d-grid gap-3 gap-lg-5">
                    ...
                    @if($user->role == 1)
                        @include('admin.user_management.components.ai_feature')
                    @endif

                    @include('admin.user_management.components.affiliate_able')
