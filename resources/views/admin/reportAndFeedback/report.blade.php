...
@section('page_title', __('Report List'))
@section('content')
    <div class="content container-fluid">
        <x-page-header menu="Report List" :statBtn="true"/>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <h6 class="card-subtitle mb-3">@lang('Active Report')</h6>
                                <h3 class="card-title js-counter" data-value="{{ $reportStats->active }}">{{ $reportStats->active }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $reportStats->total }}</span>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-4">
                <div class="card card-hover-shadow h-100 stats-card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <h6 class="card-subtitle mb-3">@lang('Holded Report')</h6>
                                <h3 class="card-title js-counter" data-value="{{ $reportStats->inactive }}">{{ $reportStats->inactive }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $reportStats->total }}</span>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                ...
                                <h3 class="card-title js-counter" data-value="{{ $reportStats->this_month }}">{{ $reportStats->this_month }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $reportStats->total }}</span>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                ...
                                <h3 class="card-title js-counter" data-value="{{ $reportStats->this_year }}">{{ $reportStats->this_year }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $reportStats->total }}</span>
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <div class="input-group input-group-merge input-group-flush">
                        ...
                        <input id="datatableSearch" type="search" class="form-control" placeholder="Search report" aria-label="Search report" autocomplete="off">
                    </div>
                </div>
                            ...
                            <div class="offcanvas-body">
                                <form id="filter_form">
                                    <div class="col-12 mb-4">
                                        ...
                                        <input type="text" class="form-control" id="filter_input" placeholder="Type here .." autocomplete="off">
                                    </div>

                                    <small class="text-cap text-body">@lang("Report Status")</small>
    ...
    <div class="modal fade" id="reportModal" tabindex="-1" aria-labelledby="reportModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="reportModalLabel">@lang('Full Report')</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
    ...
    <script>
        $(document).on('ready', function () {
            ...
            $(document).on('click', '#filter_button', function () {
                ...
                datatable.ajax.url("{{ route('admin.report.search') }}" + "?filterStatus=" + filterStatus + "&filterSearch=" + filterSearch + "&filterStartDate=" + "&filterDate=" + filterDate).load();
            });
            ...
            $(document).on('click', '.delete-multiple', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.report.delete.multiple') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
                    success: function (data) {
                        if (data.success) {
                            Notiflix.Notify.success('All selected Reports have been deleted successfully.');
                            location.reload();
                        }
                        location.reload();
                    },
        ...
        $(document).on('click', '.see-more-btn', function() {
            let fullReport = $(this).data('fullreport');

            $('#reportModalBody').html(fullReport);
