...
@section('page_title', __('Feedback List'))
@section('content')
    <div class="content container-fluid">
        <x-page-header menu="Feedback List" :statBtn="true"/>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <h6 class="card-subtitle mb-3">@lang('Active Feedback')</h6>
                                <h3 class="card-title js-counter" data-value="{{ $feedbackStats->active }}">{{ $feedbackStats->active }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $feedbackStats->total }}</span>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-4">
                <div class="card card-hover-shadow h-100 stats-card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <h6 class="card-subtitle mb-3">@lang('Inactive Feedback')</h6>
                                <h3 class="card-title js-counter" data-value="{{ $feedbackStats->inactive }}">{{ $feedbackStats->inactive }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $feedbackStats->total }}</span>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                ...
                                <h3 class="card-title js-counter" data-value="{{ $feedbackStats->this_month }}">{{ $feedbackStats->this_month }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $feedbackStats->total }}</span>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                ...
                                <h3 class="card-title js-counter" data-value="{{ $feedbackStats->this_year }}">{{ $feedbackStats->this_year }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $feedbackStats->total }}</span>
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <div class="input-group input-group-merge input-group-flush">
                        ...
                        <input id="datatableSearch" type="search" class="form-control" placeholder="Search feedback" aria-label="Search feedback" autocomplete="off">
                    </div>
                </div>
                            ...
                            <div class="offcanvas-body">
                                <form id="filter_form">
                                    <div class="col-12 mb-4">
                                        ...
                                        <input type="text" class="form-control" id="filter_input" placeholder="Search" autocomplete="off">
                                    </div>
                                    <div class="row">
    ...
    <div class="modal fade" id="reportModal" tabindex="-1" aria-labelledby="reportModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="reportModalLabel">@lang('Full Feedback')</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
    ...
    <script>
        $(document).on('ready', function () {
            ...
            $(document).on('click', '#filter_button', function () {
                ...
                datatable.ajax.url("{{ route('admin.feedback.search') }}" + "?filterSearch=" + filterSearch + "&filterStartDate=" + "&filterDate=" + filterDate).load();
            });
            ...
            $(document).on('click', '.delete-multiple', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.feedback.delete.multiple') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
