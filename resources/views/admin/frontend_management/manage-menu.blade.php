...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row mt-lg-5" id="manage-menu">
            <h3 class="ms-1 manageFooterMenu">@lang("Manage Menu For Footer")</h3>
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title h4">@lang('Pages')</h2>
                                ...
                                <div class="col-md-12">
                                    <div class="js-sortable sortablejs-custom list-group manage-menu-drop-footer"
                                        ...
                                        <div class="list-group-item mb-2 d-flex justify-content-between align-items-center">
                                            ...
                                            @endif
                                            <input type="hidden" name="menu_item[]" value="{{ strtolower($page->name) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-6 ">
                <form action="{{ route('admin.footer.menu.item.store') }}" method="post">
                    ...
                    <div class="card mt-3" id="supportLInk">
                        <div class="card-header">
                            <h2 class="card-title h4">
                                @lang('Support Link')
                            </h2>
...
@push('css')
    <style>
        .card-body.bg-soft-primary, .card-body.bg-soft-secondary{
