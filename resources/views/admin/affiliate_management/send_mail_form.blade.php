                        ...
                        <div class="d-grid gap-3 gap-lg-5">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    <h4 class="card-title mt-2">{{ trans('Send Email To ' . $affiliate->firstname .' '.$affiliate->lastname) }}</h4>
                                </div>
                                <div class="card-body mt-2">
                                    <form action="{{ route('admin.affiliate.profile.email.send', $affiliate->id) }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="mb-3">
