    ...
    <script>
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route("admin.affiliate.profile.transaction.search", $affiliate->id) }}",
                },
                columns: [
                    {data: 'no', name: 'no'},
                    {data: 'trx', name: 'trx'},
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route('admin.affiliate.profile.transaction.search', $affiliate->id) }}" + "?filterTransactionID=" + filterTransactionId +
