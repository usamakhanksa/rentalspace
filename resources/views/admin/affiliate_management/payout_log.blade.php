...
@section('page_title',__('View Affiliate Withdraw'))
@section('content')
    ...
    <script>
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route("admin.affiliate.payout.search", $affiliate->id) }}",
                },
        ...
        document.getElementById("filter_button").addEventListener("click", function () {
            ...
            datatable.ajax.url("{{ route('admin.affiliate.payout.search', $affiliate->id) }}" + "?filterTransactionID=" + filterTransactionId + "&filterStatus=" + filterStatus + "&filterMethod=" + filterMethod +
