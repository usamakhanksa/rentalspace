                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('Property Type Add')</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang('Property Type Add')</h1>
                </div>
            </div>
        </div>
                ...
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card pb-3">
                        <div class="card-header d-flex justify-content-between">
                            <h4 class="card-title m-0">@lang('Property Type Add')</h4>
                        </div>
                        <div class="card-body mt-2">
                            <form action="{{ route('admin.propertyType.store') }}" method="post"
