...
@section('page_title', __('Property Type Add'))
@section('content')
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('Property Type Edit')</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang('Property Type Edit')</h1>
                </div>
            </div>
        </div>
                ...
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card pb-3">
                        <div class="card-header d-flex justify-content-between">
                            <h4 class="card-title m-0">@lang('Property Type Edit')</h4>
                        </div>
                        <div class="card-body mt-2">
                            <form action="{{ route('admin.propertyType.update') }}" method="post"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label class="row form-check form-switch" for="breadcrumbSwitch">
                                            <span class="col-8 col-sm-9 ms-0">
                                              <span class="text-dark">@lang("Type Status")
                                            ...
                                            <span class="col-4 col-sm-3 text-end">
                                                ...
                                                <input type="checkbox" class="form-check-input" name="status"
                                                       id="breadcrumb" value="1" {{ old('status', $type->status) == 1 ? 'checked' : ' ' }}>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label class="form-check form-check-dashed form-label mt-0" for="image">
                                            <img id="categoryImage"
                                                 ...
                                                 src="{{ getFile($type->driver, $type->image) }}"
                                                 alt="@lang("Image")"
                                ...
                                <div class="d-flex justify-content-start mt-4">
                                    <button type="submit" class="btn btn-primary submit_btn"><i class="bi-check-circle pe-1"></i>@lang('Updtae')</button>
                                </div>
