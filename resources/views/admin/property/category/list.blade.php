...
@section('page_title', __('Property Categories'))
@section('content')
    <div class="content container-fluid">
        <x-page-header menu="Property Categories" :statBtn="true"/>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <h6 class="card-subtitle mb-3">@lang('active categories')</h6>
                                <h3 class="card-title js-counter" data-value="{{ $categoryStats->active }}">{{ $categoryStats->active }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $categoryStats->total }}</span>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-4">
                <div class="card card-hover-shadow h-100 stats-card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <h6 class="card-subtitle mb-3">@lang('inactive categories')</h6>
                                <h3 class="card-title js-counter" data-value="{{ $categoryStats->inactive }}">{{ $categoryStats->inactive }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $categoryStats->total }}</span>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                ...
                                <h3 class="card-title js-counter" data-value="{{ $categoryStats->this_month }}">{{ $categoryStats->this_month }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $categoryStats->total }}</span>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                ...
                                <h3 class="card-title js-counter" data-value="{{ $categoryStats->this_year }}">{{ $categoryStats->this_year }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $categoryStats->total }}</span>
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <div class="input-group input-group-merge input-group-flush">
                        ...
                        <input id="datatableSearch" type="search" class="form-control" placeholder="Search category" aria-label="Search category" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                            ...
                            <div class="offcanvas-body">
                                <form id="filter_form">
                                    ...
                                    <small class="text-cap text-body">@lang("Category Status")</small>
                    ...
                    <div class="dropdown">
                        <a href="{{ route('admin.property.categoryAdd') }}" class="btn btn-primary btn-sm"><i class="bi bi-plus-circle pe-1"></i>@lang("Add New")</a>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="" method="post">
                    @csrf
                    <div class="modal-body">
                        @lang('Do you want to delete all selected category data?')
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-white" data-bs-dismiss="modal">@lang('Close')</button>
    ...
    <script>
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route("admin.property.categoryList.search") }}",
                },
                columns: [
            ...
            $(document).on('click', '#filter_button', function () {
                ...
                datatable.ajax.url("{{ route('admin.property.categoryList.search') }}" + "?filterStatus=" + filterStatus +
            ...
            $(document).on('click', '.statusMultiple', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.category.status.multiple') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
                    success: function (data) {
                        if (data.success) {
                            Notiflix.Notify.success('All selected categories status changed successfully.');
                            location.reload();
                        }
                        location.reload();
                    },
            ...
            $(document).on('click', '.delete-multiple', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.property.categoryDelete.multiple') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
                    success: function (data) {
                        if (data.success) {
                            Notiflix.Notify.success('All selected Categories have been deleted successfully.');
                            location.reload();
                        }
                        location.reload();
                    },
