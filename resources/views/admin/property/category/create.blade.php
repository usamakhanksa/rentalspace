...
@section('page_title', __('Property Category Add'))
@section('content')
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('Property Category Add')</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang('Property Category Add')</h1>
                </div>
            </div>
        </div>
                ...
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card pb-3">
                        <div class="card-header d-flex justify-content-between">
                            <h4 class="card-title m-0">@lang('Property Category Add')</h4>
                        </div>
                        <div class="card-body mt-2">
                            <form action="{{ route('admin.property.categoryStore') }}" method="post"
                                            ...
                                            <span class="col-8 col-sm-9 ms-0">
                                              <span class="text-dark">@lang("Category Status")
                                                  <i class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                                     ...
                                                     data-bs-original-title="@lang("Enable Category for user create property")"></i></span>
                                            </span>
