...
@section('page_title', __('Property Styles'))
@section('content')
    <div class="content container-fluid">
        <x-page-header menu="Property Styles" :statBtn="true"/>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <h6 class="card-subtitle mb-3">@lang('Active Styles')</h6>
                                <h3 class="card-title js-counter" data-value="{{ $propertyStyleStats->active }}">{{ $propertyStyleStats->active }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $propertyStyleStats->total }}</span>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-4">
                <div class="card card-hover-shadow h-100 stats-card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <h6 class="card-subtitle mb-3">@lang('Inactive Styles')</h6>
                                <h3 class="card-title js-counter" data-value="{{ $propertyStyleStats->inactive }}">{{ $propertyStyleStats->inactive }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $propertyStyleStats->total }}</span>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                ...
                                <h3 class="card-title js-counter" data-value="{{ $propertyStyleStats->this_month }}">{{ $propertyStyleStats->this_month }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $propertyStyleStats->total }}</span>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                ...
                                <h3 class="card-title js-counter" data-value="{{ $propertyStyleStats->this_year }}">{{ $propertyStyleStats->this_year }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $propertyStyleStats->total }}</span>
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <div class="input-group input-group-merge input-group-flush">
                        ...
                        <input id="datatableSearch" type="search" class="form-control" placeholder="Search styles"
                               aria-label="Search styles" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                    ...
                    <div class="dropdown">
                        <a href="{{ route('admin.propertyStyle.create') }}" class="btn btn-primary btn-sm"><i class="bi bi-plus-circle pe-1"></i>@lang("Add New")</a>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="" method="post" class="setRoute">
                    ...
                    @method("delete")
                    <div class="modal-body">
                        <p>@lang("Do you want to delete this style?")</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-white" data-bs-dismiss="modal">@lang('Close')</button>
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route("admin.all.propertyStyle.search") }}",
                },
                columns: [
            ...
            $(document).on('click', '#filter_button', function () {
                ...
                datatable.ajax.url("{{ route('admin.all.propertyStyle.search') }}" + "?filterStatus=" + filterStatus +
            ...
            $(document).on('click', '.statusMultiple', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.propertyStyle.statusMultiple') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
            ...
            $(document).on('click', '.delete-multiple', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.propertyStyle.deleteMultiple') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
                    success: function (data) {
