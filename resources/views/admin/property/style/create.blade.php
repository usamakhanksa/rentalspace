...
@section('page_title', __('Property Style Add'))
@section('content')
        ...
        <div class="page-header">
            <div class="row align-items-end">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <h1 class="page-header-title">@lang('Property Style Add')</h1>
                </div>
            </div>
        </div>
                ...
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card pb-3">
                        <div class="card-header d-flex justify-content-between">
                            <h4 class="card-title m-0">@lang('Property Style Add')</h4>
                        </div>
                        <div class="card-body mt-2">
                            <form action="{{ route('admin.propertyStyle.store') }}" method="post"
