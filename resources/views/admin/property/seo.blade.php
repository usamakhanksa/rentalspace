...
@section('page_title', __('Property SEO'))
@section('content')
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('Property SEO')</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">
                        @lang(isset($property->title) ? "\"$property->title\" SEO update" : 'SEO update')
                    </h1>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-10">
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.property.seo.update') }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <div class="tom-select-custom">
                                            <select class="js-select form-select" name="meta_keywords[]"
                                                ...
                                                @if($property->seo?->meta_keywords)
                                                    @foreach($property->seo?->meta_keywords as $key => $data)
                                    ...
                                    <div class="col-sm-12 mb-4">
                                        ...
                                        <textarea id="metaDescription" class="form-control" name="meta_description" placeholder="@lang("Meta Description")" rows="5">{{ old("meta_description", $property->seo?->meta_description) }}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="tom-select-custom tom-select-custom-with-tags">
                                        ...
                                        <select class="js-select form-select meta-robot-select2" autocomplete="off"
                                            ...
                                            <option value="index" {{ in_array("index", $metaRobots) ? 'selected' : '' }}>@lang('Index')</option>
                                            <option value="noindex" {{ in_array("noindex", $metaRobots) ? 'selected' : '' }}>@lang('No index')</option>
                                            <option value="follow" {{ in_array("follow", $metaRobots) ? 'selected' : '' }}>@lang('Follow')</option>
                                            <option value="nofollow" {{ in_array("nofollow", $metaRobots) ? 'selected' : '' }}>@lang('No follow')</option>
                                            <option value="noarchive" {{ in_array("noarchive", $metaRobots) ? 'selected' : '' }}>@lang('No archive')</option>
                                            <option value="nosnippet" {{ in_array("nosnippet", $metaRobots) ? 'selected' : '' }}>@lang('No snippet')</option>
                                        </select>
                                    </div>
                                </div>
