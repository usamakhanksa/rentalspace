                            ...
                            <form action="{{ route('admin.basic.control.update') }}" method="post">
                                        ...
                                        <div class="tom-select-custom">
                                            <select
                                                ...
                                                @foreach(timezone_identifiers_list() as $key => $value)
                                                    <option value="{{$value}}" {{  (old('time_zone',$basicControl->time_zone) == $value ? ' selected' : '') }}>{{ $value}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        @error('time_zone')
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="tom-select-custom">
                                            <select class="js-select form-select @error('date_format') is-invalid @enderror" id="dateFormatLabel" name="date_format">
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-6">
                                        <label for="contactNumberLabel" class="form-label">@lang("Contact Number")</label>
                                        <input type="text"
                                               class="form-control @error('contact_number') is-invalid @enderror"
                                               name="contact_number" id="contactNumberLabel"
                                               placeholder="@lang("Contact Number")"
                                               aria-label="@lang("Contact NUmber")"
                                               autocomplete="off"
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text"
                                               ...
                                               name="address" id="addressLabel"
                                               placeholder="@lang("Address")"
                                               aria-label="@lang("Address")"
                                               autocomplete="off"
                                               value="{{ old('address', $basicControl->address) }}">
                                        @error('address')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-12">
                                        <label for="countryLabel" class="form-label">@lang("Country")</label>
                                        <div class="tom-select-custom">
                                            <select class="js-select form-select @error('country') is-invalid @enderror" id="countryLabel" name="country">
                                                @foreach($countries as $key => $value)
                                                    <option value="{{ $value->iso2 }}" {{ (old('country', $basicControl->country) == Str::lower($value->iso2) ? ' selected' : '') }}>{{ $value->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        @error('contact_number')
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <h5 class="mb-0">@lang('Affiliate Registration')</h5>
                                                    <span class="d-block fs-6 text-body">
                                                        @lang('Enable or Disable Affiliate Registration')
                                                    </span>
                                                </div>
                                                <div class="col-auto">
                                                    <label class="row form-check form-switch mb-3" for="affiliate_registration">
                                                        <span class="col-4 col-sm-3 text-end">
                                                            <input type='hidden' value='0' name='affiliate_registration'>
                                                             <input
                                                                 class="form-check-input @error('affiliate_registration') is-invalid @enderror"
                                                                 type="checkbox" name="affiliate_registration"
                                                                 id="affiliate_registration"
                                                                 value="1" {{($basicControl->affiliate_registration == 1) ? 'checked' : ''}}>
                                                            </span>
