...
@section('content')
    <div class="content container-fluid">
        <x-page-header menu="Payment Log" :statBtn="true"/>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <h6 class="card-subtitle mb-3">@lang('Today Payments')</h6>
                                <h3 class="card-title js-counter" data-value="{{ fractionNumber($paymentRecord[0]['todayCreated'], false) }}">{{ fractionNumber($paymentRecord[0]['todayCreatedPercentage'], false) }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ fractionNumber($paymentRecord[0]['totalPaymentLog'], false) }}</span>
                                    <span class="badge bg-soft-success text-success ms-2">
                                        <i class="bi-graph-up"></i> {{ number_format(fractionNumber($paymentRecord[0]['todayCreatedPercentage'], false), 2) }}%
                                    </span>
                                </div>
                            </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-4">
                <div class="card card-hover-shadow h-100 stats-card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <h6 class="card-subtitle mb-3">@lang("Cancel Payment")</h6>
                                        ...
                                        <div class="col-12 mb-4">
                                            ...
                                            <div class="tom-select-custom">
                                                <select class="js-select form-select" id="filter_method">
                                                    <option value="all" data-option-template='<span class="d-flex align-items-center"><img class="avatar avatar-xss avatar-circle me-2" src="{{ asset("assets/upload/gateway/all_gateway.png")  }}" alt="..." /><span class="text-truncate">@lang("All Gateway")</span></span>'
