                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 ">
                                        <div class="card-box pt-3">
                                            <div class="row g-4">
                                                <label class="form-label">@lang('Country Icon')</label>
                                                <label class="form-check form-check-dashed form-label" for="image">
                                                    ...
                                                    <img id="countryIcon"
                                                         ...
                                                         alt="@lang("Country Image")" data-hs-theme-appearance="dark">
                                                    <span class="d-block">@lang("Browse your file here")</span>
                                                    <input type="file" class="js-file-attach form-check-input"
                                                           name="image" id="image"
                                                           data-hs-file-attach-options='{
                                                              "textTarget": "#countryIcon",
                                                              "mode": "image",
                                                              "targetAttr": "src",
                                            ...
                                            <div class="row g-4">
                                                ...
                                                <label class="form-check form-check-dashed form-label" for="thumb">
                                                    ...
                                                    <img id="countryThumb"
                                                         class="avatar avatar-xl avatar-4x3 avatar-centered h-100 mb-2"
                                                         src="{{ asset("assets/admin/img/oc-browse-file-light.svg") }}"
                                                         alt="@lang("Country Thumbnail")" data-hs-theme-appearance="dark">
                                                    <span class="d-block">@lang("Browse your file here")</span>
                                                    <input type="file" class="js-file-attach form-check-input"
                                                           name="thumb" id="thumb"
                                                           data-hs-file-attach-options='{
                                                              "textTarget": "#countryThumb",
                                                              "mode": "image",
                                                              "targetAttr": "src",
                                                              "allowTypes": [".png", ".jpeg", ".jpg"]
                                                       }'>
