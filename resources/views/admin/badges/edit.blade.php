...
@section('page_title', __('Badge Edit'))
@section('content')
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('Badge Edit')</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang('Badge Edit Form')</h1>
                </div>
            </div>
        </div>
                ...
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card pb-3">
                        <div class="card-header d-flex justify-content-between">
                            <h4 class="card-title m-0">@lang('Edit Badge')</h4>
                            <a type="button" href="{{ route('admin.badge.list') }}" class="btn btn-info float-end"><i class="bi bi-arrow-left"></i>@lang('Back')</a>
                        </div>
                        <div class="card-body mt-2">
                            <form action="{{ route('admin.badge.update') }}" method="post"
                                  enctype="multipart/form-data">
                                @csrf

                                <input type="hidden" name="badge" value="{{ $badge->id }}" />
                                ...
                                <div class="row mb-4 d-flex align-items-center">
                                            ...
                                            <div class="col-sm-auto d-flex align-items-center">
                                                <div class="form-check form-switch form-switch-google">
                                                    ...
                                                    <input class="form-check-input" name="status"
                                                           type="checkbox" id="status" value="1" {{ old('status', $badge->status) == 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6 mt-5">
                                        ...
                                        <textarea class="form-control summernote" name="description" id="description" rows="10">{{ old("description", $badge->description) }}</textarea>
                                        @error("description")
                                            ...
                                            <div class="card-body">
                                                ...
                                                <label class="form-check form-check-dashed @error('icon') is-invalid @enderror" for="logoUploader" id="category_icon">
                                                    <img id="previewImage"
                                                         ...
                                                         src="{{ getFile($badge->driver, $badge->icon) }}"
                                ...
                                <div class="d-flex justify-content-start">
                                    <button type="submit" class="btn btn-primary submit_btn">@lang('Update')</button>
                                </div>
