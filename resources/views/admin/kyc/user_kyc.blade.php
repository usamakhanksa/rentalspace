...
@section('content')
    <div class="content container-fluid">
        <x-page-header menu="User KYC List" :statBtn="true"/>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <h6 class="card-subtitle mb-3">@lang('Today Kyc')</h6>
                                <h3 class="card-title js-counter" data-value="{{ $userKYCRecord[0]['todayCreatedKYC'] }}">{{ $userKYCRecord[0]['todayCreatedKYC'] }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $userKYCRecord[0]['totalKYC'] }}</span>
                                    <span class="badge bg-soft-info text-info ms-2">
                                        <i class="bi-graph-up"></i> {{ number_format($userKYCRecord[0]['todayCreatedKYCPercentage'], 2) }}%
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            ...
                            <span class="icon icon-soft-warning icon-lg icon-circle ms-3">
                                <i class="bi-bootstrap-reboot fs-1"></i>
                            </span>
                        </div>
                    </div>
                </div>
