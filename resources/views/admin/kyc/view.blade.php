...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-lg-4">
                @if(optional($userKyc->affiliate)->id)
                    <div class="card mb-3 mb-lg-5">
                        <div class="card-header card-header-content-between">
                            <h4 class="card-header-title">@lang("User Profile")</h4>
                            <a class="btn btn-white btn-sm" href="{{ route('admin.user.view.profile', optional($userKyc->affiliate)->id)  }}"><i class="bi-eye me-1"></i> @lang("View Profile")</a>
                        </div>
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled list-py-2 text-dark mb-0">
                                ...
                                <li>
                                    <i class="bi-person dropdown-item-icon"></i> @lang(optional($userKyc->affiliate)->firstname . " " . optional($userKyc->affiliate)->lastname)
                                </li>
                                <li>
                                    <i class="bi-briefcase dropdown-item-icon"></i> @lang('@'.optional($userKyc->affiliate)->username)
                                </li>


                                <li class="pt-4 pb-0"><span class="card-subtitle">@lang("Contacts")</span></li>
                                <li><i class="bi-at dropdown-item-icon"></i> @lang(optional($userKyc->affiliate)->email)</li>
                                <li><i class="bi-phone dropdown-item-icon"></i> @lang(optional($userKyc->affiliate)->phone)</li>

                                @if(optional($userKyc->affiliate)->country)
                                    <li class="pt-4 pb-0"><span class="card-subtitle">@lang("Address")</span></li>
                                    <li class="fs-6 text-body">
                                        <i class="bi bi-geo-alt dropdown-item-icon"></i> @lang(optional($userKyc->affiliate)->country)
                                    </li>
                                @endif
                            </ul>
                        </div>
                ...
                @else
                    <div class="card mb-3 mb-lg-5">
                        <div class="card-header card-header-content-between">
                            <h4 class="card-header-title">@lang("User Profile")</h4>
                            <a class="btn btn-white btn-sm" href="{{ route('admin.user.view.profile', optional($userKyc->user)->id)  }}"><i class="bi-eye me-1"></i> @lang("View Profile")</a>
                        </div>
