...
@section('page_title', __('Affiliate KYC'))
@section('content')
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('Affiliate KYC')</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang('Affiliate KYC Form')</h1>
                </div>
            </div>
        </div>
                ...
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card pb-3">
                        ...
                        <div class="card-body mt-2">
                            <form action="{{ route('admin.affiliate.kyc.store') }}" method="post"
