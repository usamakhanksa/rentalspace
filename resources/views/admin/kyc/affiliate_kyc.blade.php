...
@section('content')
    <div class="content container-fluid">
        <x-page-header menu="Affiliate Kycs" :statBtn="true"/>
...
@push('script')
    <script>
        ...
        $(document).on('ready', function () {
            ...
            ajaxUrl = "{{ route('admin.affiliate.kyc.requests.search') }}";
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route("admin.affiliate.kyc.requests.search" ) }}" + "?name=" + name +
