                                    ...
                                    @if($ticket->status != 3)
                                        <div class="message-wrapper-header-btn">
                                            <button class="btn-3 other_btn set" type="button"
                                                    data-route="{{ route('user.ticket.closed', $ticket->id) }}"
                                                ...
                                                <div class="sender text-end">
                                                    <div class="sender-inner">
                                                        <div class="sender-image">
                                                            <img src="{{ getFile($ticket->user->image_driver, $ticket->user->image) }}" alt="{{ $ticket->user->firstname.' '.$ticket->user->lastname }}">
                                                        </div>
                                ...
                                <form class="form-row mt-4" action="{{ route('user.ticket.reply', $ticket->id)}}"
                                    ...
                                    <div class="message-input-box">
                                        ...
                                        <div class="message-input">
                                            ...
                                            <button type="submit" name="replayTicket" value="1"><i class="fa-light fa-arrow-right"></i></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            modal.addEventListener('show.bs.modal', function (event) {
                ...
                modal.querySelector('form.setRoute').setAttribute('action', route);
            });
        });
    </script>
@endpush
