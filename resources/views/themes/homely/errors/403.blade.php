        ...
        <div class="container mx-auto px-6">
            <div class="grid md:grid-cols-2 gap-10 items-center">
                ...
                <div class="d-flex align-items-center justify-content-center">
                    <img src="{{ asset('assets/global/img/errors/403.jpg')}}"
                         alt="403 Forbidden Illustration"
                         class="error-image max-w-sm drop-shadow-2xl animate-bounce-slow">
                </div>

                <div class="text-center md:text-left space-y-6">
                    <h1 class="text-5xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-yellow-500">
                        @lang('Forbidden')
                    </h1>
                    <p class="text-xl md:text-2xl font-semibold">
                        @lang("You don't have permission to access ‘/’ on")
                        <span class="text-red-400">@lang('this server')</span>
                    </p>
                    <p class="text-gray-400">
                        @lang('Please contact your administrator if you believe this is a mistake.')
                    </p>
