@if(isset($banner_section_one))
    <input type="hidden" name="home_destinations" id="home_destinations" value="{{ $banner_section_one['home_destinations'] ?? '' }}" />
    <section class="banner-section-one banner-section">
        <div class="container">
            <div class="banner-one-container">
                <div class="bg-shape-layer" style="background-image: url({{ getFile($banner_section_one['single']['media']->background_image->driver, $banner_section_one['single']['media']->background_image->path) }});"></div>
                <div class="banner-content-box">
                    <h2>{{ $banner_section_one['single']['title_part_one'] ?? '' }} <span>{!! $banner_section_one['single']['title_part_two'] ?? '' !!} </span> {!! $banner_section_one['single']['title_part_three'] ?? '' !!}</h2>
                    <div class="banner-btn">
                        <a class="btn-2" href="{{ route('services') }}">
                            <div class="btn-wrapper">
                                <div class="main-text btn-single">
                                    {{ $banner_section_one['single']['button_name'] ?? '' }}
                                    <div class="icon-box">
                                        <svg
                        ...
                        <div class="destination-search-inner">
                            <div class="location-search-box">
                                <div class="select-option">
                                    ...
                                    <div class="select-option-content">
                                        <h6 class="select-option-title">{{ $banner_section_one['single']['search_text_one'] ?? '' }}</h6>
                                        <input
                                            type="search"
                            ...
                            <div class="date">
                                <div class="select-option">
                                    ...
                                    <div class="select-option-content">
                                        <h6 class="select-option-title">{{ $banner_section_one['single']['search_text_two'] ?? '' }}</h6>
                                        <input
                                            type="text"
                                            id="date-picker"
                                            name="datefilter"
                            ...
                            <div class="count">
                                ...
                                <div class="count-counter select-option">
                                    ...
                                    <div class="select-option-content">
                                        <h6 class="select-option-title">{{ $banner_section_one['single']['search_text_three'] ?? '' }}</h6>
                            ...
                            <button type="submit" class="btn-1">
                                <div class="btn-wrapper">
                                    <div class="main-text btn-single">
                                        ...
                                        <span class="d-md-none d-xl-block">{{ $banner_section_one['single']['search_button'] ?? '' }}</span>
                                    </div>
                                    <div class="hover-text btn-single">
                                        <i class="fa-regular fa-magnifying-glass"></i>
                                        <span class="d-md-none d-xl-block">{{ $banner_section_one['single']['search_button'] ?? '' }}</span>
                ...
                <a href="#categories" class="arrow-btn">
                    <i class="fa-regular fa-long-arrow-down"></i>
                </a>
            </div>
        </div>
    </section>
