                            ...
                            <div class="sign-in-form">
                                <form action="{{ route('user.mail.verify') }}" method="post">
                                    ...
                                    <div class="sign-in-form-group">
                                        <input type="text" class="sign-in-input" name="code" value="{{old('code')}}" placeholder="@lang('Code')" autocomplete="off">
                                        @error('code')
                                ...
                                <div class="swap-area">
                                    <h5>@lang('Didn\'t get Code? Click to ')<a href="{{route('user.resend.code')}}?type=email"  class="text-info"> @lang('Resend code')</a></h5>
                                    @error('resend')
